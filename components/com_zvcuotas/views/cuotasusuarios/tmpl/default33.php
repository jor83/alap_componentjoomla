...
//echo '</pre>';
?>
<h2 style="color:red;">Pagar Cuota  PAYPAL</h2>
<div id="divformularioPrincipal" >
    <form id="formulario" name="formulario" action="<?php echo JRoute::_('index.php?option=com_zvcuotas&view=cuotasusuarios&layout=getpaypal');?>" method="post">
...
<script>
    ...
    <?php foreach ($this->cuotasDisponiveis as $x => $deuda) {?>
        ...
        if (cb.checked && cbEsEstudiante.checked == true)
        {
            ...
            //
            document.formulario.valor_total.value = document.formulario.total_real3.value;
        }
        else
        {
            //console.log('aqui');
