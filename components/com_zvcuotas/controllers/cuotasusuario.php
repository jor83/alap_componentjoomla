 ...
 * @since  1.6
 */
class ZvcuotasControllerCuotasusuario extends ZvcuotasController
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Cuotasusuario', 'ZvcuotasModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_zvcuotas') || $user->authorise('core.edit.state', 'com_zvcuotas'))
		{
			$model = $this->getModel('Cuotasusuario', 'ZvcuotasModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_zvcuotas&view=cuotasusuarios', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_zvcuotas'))
		{
			$model = $this->getModel('Cuotasusuario', 'ZvcuotasModel');
