...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="zv_direccionprovincia">Provincia/Estado/Región/Dpto:  </label>
  <div class="col-md-6">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="zv_faxlaboral">Fax:</label>
  <div class="col-md-6">
  <input id="zv_faxlaboral" name="zv_faxlaboral" type="text" placeholder="" class="form-control input-md" required="">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="zv_emaillaboral">Email laboral:</label>
  <div class="col-md-6">
  <input id="zv_emaillaboral" name="zv_emaillaboral" type="text" placeholder="" class="form-control input-md" required="">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="zv_direcionlaboralbarrio">Barrio:</label>
  <div class="col-md-6">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="zv_titulopostgrado">Título postgrado completo:</label>
  <div class="col-md-6">
...
<!-- Multiple zv_areainteres[] -->
<div class="form-group">
  <label class="col-md-4 control-label" for="zv_areainteres[]">Multiple zv_areainteres[]</label>
  <div class="col-md-4">
  <div class="checkbox">
