...
<p style="color:#5A0101;"><strong>Nota: si se trata de una afiliación institucional, llene con los datos de la institución los campos  cuando correspondan.</p></strong>
...
<!-- Text input-->
<div class="control-group">
  <label class="span4 control-label" for="zv_apellidopadre">Apellido:</label>  
  <div class="span5">
